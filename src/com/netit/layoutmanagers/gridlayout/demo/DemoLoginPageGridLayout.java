...
import com.netit.layoutmanagers.gridlayout.helpers.LoginPageGridLayoutClass;

public class DemoLoginPageGridLayout {

	public static void main(String[] args) {
		LoginPageGridLayoutClass gridLayoutClass = new LoginPageGridLayoutClass();
		gridLayoutClass.addComponents(gridLayoutClass.getContentPane());
		gridLayoutClass.setTitle("Login Page Example");
